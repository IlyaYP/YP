...
/*
Задание 3
Есть сообщение в 16-битном формате, состоящее из идентификатора uint32 и подписи.
Проверьте подпись алгоритмом HMAC, используя хеш-функцию SHA256 и секретный ключ.
Выведите значение идентификатора.
*/
